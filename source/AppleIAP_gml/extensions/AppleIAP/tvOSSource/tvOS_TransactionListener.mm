...
@implementation tvOS_TransactionListener

@synthesize m_activeTransactions;

+ (tvOS_TransactionListener *)sharedInstance {
    static dispatch_once_t onceToken;
    static tvOS_TransactionListener * transactionListenerSharedInstance;
    
    dispatch_once(&onceToken, ^{
        transactionListenerSharedInstance = [[tvOS_TransactionListener alloc] init];
    });
