...
@interface tvOS_StoreManager()<SKRequestDelegate, SKProductsRequestDelegate>

@property (retain) SKProductsRequest *productRequest;

@end

@implementation tvOS_StoreManager
...
+ (tvOS_StoreManager *)sharedInstance 
{
	...
	static tvOS_StoreManager * storeManagerSharedInstance;

	dispatch_once(&onceToken, ^
    {
		storeManagerSharedInstance = [[tvOS_StoreManager alloc] init];
	});
