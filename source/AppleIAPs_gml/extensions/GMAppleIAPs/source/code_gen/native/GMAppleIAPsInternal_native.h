...
namespace gm_structs
{
    ...
    struct AppleIAPVerifiedTransaction;
    ...
    struct AppleIAPTransaction
    {
        ...
        std::int32_t revocation_reason;
        bool is_upgraded;
        std::int32_t ownership_type;
    ...
    struct AppleIAPProductsResult
    {
        ...
        std::int32_t status;
        std::string message;
        std::vector<gm_structs::AppleIAPProduct> products;
    };

    struct AppleIAPVerifiedTransaction
    {
        bool verified;
        gm_structs::AppleIAPTransaction transaction;
    ...
    struct AppleIAPPurchaseResult
    {
        ...
        std::int32_t status;
        std::string message;
        gm_structs::AppleIAPVerifiedTransaction transaction;
    };
    ...
    struct AppleIAPTransactionsResult
    {
        ...
        std::int32_t status;
        std::string message;
        std::vector<gm_structs::AppleIAPVerifiedTransaction> transactions;
    };
...
namespace gm::wire::codec
{
    ...
    inline gm_structs::AppleIAPTransaction readValue<gm_structs::AppleIAPTransaction>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.product_type = gm::wire::codec::readValue<std::int32_t>(_buf);
        ...
        obj.revocation_reason = gm::wire::codec::readValue<std::int32_t>(_buf);
        obj.is_upgraded = gm::wire::codec::readValue<bool>(_buf);
        obj.ownership_type = gm::wire::codec::readValue<std::int32_t>(_buf);
        obj.environment = gm::wire::codec::readValue<std::int32_t>(_buf);
    ...
    inline gm_structs::AppleIAPProductsResult readValue<gm_structs::AppleIAPProductsResult>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.status = gm::wire::codec::readValue<std::int32_t>(_buf);
        obj.message = gm::wire::codec::readValue<std::string>(_buf);
        obj.products = gm::wire::codec::readVector<gm_structs::AppleIAPProduct>(_buf);
        return obj;
    }

    template<>
    inline void writeValue<gm_structs::AppleIAPVerifiedTransaction>(gm::byteio::IByteWriter& _buf, const gm_structs::AppleIAPVerifiedTransaction& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.verified);
        gm::wire::codec::writeValue(_buf, obj.transaction);
        gm::wire::codec::writeValue(_buf, obj.verification_error);
    }

    template<>
    inline gm_structs::AppleIAPVerifiedTransaction readValue<gm_structs::AppleIAPVerifiedTransaction>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::AppleIAPVerifiedTransaction obj;
        obj.verified = gm::wire::codec::readValue<bool>(_buf);
        obj.transaction = gm::wire::codec::readValue<gm_structs::AppleIAPTransaction>(_buf);
        obj.verification_error = gm::wire::codec::readValue<std::string>(_buf);
        return obj;
    }
    ...
    inline gm_structs::AppleIAPPurchaseResult readValue<gm_structs::AppleIAPPurchaseResult>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.status = gm::wire::codec::readValue<std::int32_t>(_buf);
        obj.message = gm::wire::codec::readValue<std::string>(_buf);
        obj.transaction = gm::wire::codec::readValue<gm_structs::AppleIAPVerifiedTransaction>(_buf);
        return obj;
    }
    ...
    inline void writeValue<gm_structs::AppleIAPTransactionsResult>(gm::byteio::IByteWriter& _buf, const gm_structs::AppleIAPTransactionsResult& obj)
    {
        ...
        gm::wire::codec::writeValue(_buf, obj.status);
        gm::wire::codec::writeValue(_buf, obj.message);
        gm::wire::codec::writeValue(_buf, obj.transactions);
    }
    ...
    inline gm_structs::AppleIAPTransactionsResult readValue<gm_structs::AppleIAPTransactionsResult>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.status = gm::wire::codec::readValue<std::int32_t>(_buf);
        obj.message = gm::wire::codec::readValue<std::string>(_buf);
        obj.transactions = gm::wire::codec::readVector<gm_structs::AppleIAPVerifiedTransaction>(_buf);
        return obj;
    }
...
namespace gm::wire::details
{
    ...
    template<>
    struct gm_struct_traits<gm_structs::AppleIAPVerifiedTransaction>
    {
        static constexpr bool is_gm_struct = true;
...
void apple_iap_transactions_updates(const gm::wire::GMFunction& callback);
bool apple_iap_transactions_updates_stop();
