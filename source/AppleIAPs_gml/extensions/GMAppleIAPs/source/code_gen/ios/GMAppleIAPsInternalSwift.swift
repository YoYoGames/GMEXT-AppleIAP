...
open class GMAppleIAPsInternalSwift
{
    ...
    open func apple_iap_product_purchase(product_id: String, callback: GMFunction)
    {
    ...
    public func __EXT_SWIFT__apple_iap_product_purchase(_ __arg_buffer: UnsafeMutablePointer<CChar>?, arg1 __arg_buffer_length: Double) -> Double
    {
        do
        {
            ...
            self.apple_iap_product_purchase(product_id: product_id, callback: callback)
            return 0.0
        }
        catch
        {
    ...
    public func __EXT_SWIFT__GMAppleIAPs_invocation_handler(_ __ret_buffer: UnsafeMutablePointer<CChar>?, arg1 __ret_buffer_length: Double) -> Double
    {
