...
#import "GMAppleIAPsInternal_ios.h"

#ifdef __cplusplus
#import "GMAppleIAPs-Swift.h"
using namespace GMAppleIAPs;
#endif
...
@interface GMAppleIAPsInternal ()
{
    GMAppleIAPsSwift * __impl;
}@end


@implementation GMAppleIAPsInternal
...
+ (void)load
{
    ...
    Class base = [GMAppleIAPsInternal class];
...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        __impl = new GMAppleIAPsSwift(GMAppleIAPsSwift::init());
        #endif
    }
    return self;
}
...
{
    __impl->__EXT_SWIFT__apple_iap_products(__arg_buffer, __arg_buffer_length);
    return 0;
}

- (double)__EXT_NATIVE__apple_iap_product_purchase:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    __impl->__EXT_SWIFT__apple_iap_product_purchase(__arg_buffer, __arg_buffer_length);
    return 0;
}
...
{
    __impl->__EXT_SWIFT__apple_iap_transactions_current_entitlement(__arg_buffer, __arg_buffer_length);
    return 0;
}

- (double)__EXT_NATIVE__apple_iap_transactions_current_entitlements:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    __impl->__EXT_SWIFT__apple_iap_transactions_current_entitlements(__arg_buffer, __arg_buffer_length);
    return 0;
}

- (double)__EXT_NATIVE__apple_iap_transactions_latest:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    __impl->__EXT_SWIFT__apple_iap_transactions_latest(__arg_buffer, __arg_buffer_length);
    return 0;
}

- (double)__EXT_NATIVE__apple_iap_transactions_unfinished:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    __impl->__EXT_SWIFT__apple_iap_transactions_unfinished(__arg_buffer, __arg_buffer_length);
    return 0;
}

- (double)__EXT_NATIVE__apple_iap_transactions_all:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    __impl->__EXT_SWIFT__apple_iap_transactions_all(__arg_buffer, __arg_buffer_length);
    return 0;
}

- (double)__EXT_NATIVE__apple_iap_synchronize:(char*)__arg_buffer arg1:(double)__arg_buffer_length
{
    __impl->__EXT_SWIFT__apple_iap_synchronize(__arg_buffer, __arg_buffer_length);
    return 0;
}

// Internal function used for fetching dispatched function calls to GML
- (double)__EXT_NATIVE__GMAppleIAPs_invocation_handler:(char*)__ret_buffer arg1:(double)__ret_buffer_length
{
    return __impl->__EXT_SWIFT__GMAppleIAPs_invocation_handler(__ret_buffer, __ret_buffer_length);
}
