...
#import "GMAppleIAPInternal_ios.h"

#ifdef __cplusplus
#import "GMAppleIAP-Swift.h"
using namespace GMAppleIAP;
#endif
...
@interface GMAppleIAPInternal ()
{
    GMAppleIAPSwift * __impl;
}@end


@implementation GMAppleIAPInternal
...
+ (void)load
{
    ...
    Class base = [GMAppleIAPInternal class];
...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        __impl = new GMAppleIAPSwift(GMAppleIAPSwift::init());
        #endif
    }
    return self;
}
...
{
    return __impl->__EXT_SWIFT__GMAppleIAP_invocation_handler(__ret_buffer, __ret_buffer_length);
}
