...
public enum AppleIAPError: Int32
{
    case None = 0
    case ProductUnavailable = 1
    case PurchaseNotAllowed = 2
    case IneligibleForOffer = 3
    case InvalidOfferPrice = 4
    case InvalidOfferSignature = 5
    case InvalidOfferIdentifier = 6
    case InvalidQuantity = 7
    case MissingOfferParameters = 8
    case PaymentMethodBindingConfigurationRequired = 9
    case NetworkError = 10
    case SystemError = 11
    case StoreUserCancelled = 12
    case NotAvailableInStorefront = 13
    case NotEntitled = 14
    case Unsupported = 15
    case InvalidPresentationContext = 16
    case Unknown = 17
}
...
public enum AppleIAPTransactionOfferType: Int32
{
    case Introductory = 0
    case Promotional = 1
    case Code = 2
...
public enum AppleIAPTransactionOfferPaymentMode: Int32
{
    case FreeTrial = 0
    case PayAsYouGo = 1
    case PayUpFront = 2
...
public struct AppleIAPTransactionOffer: ITypedStruct
{
    public var id: String?
    public var type: AppleIAPTransactionOfferType
...
public struct AppleIAPProductsResult: ITypedStruct
{
    ...
    public var error: AppleIAPError
...
public struct AppleIAPTransaction: ITypedStruct
{
    ...
    public var offer: AppleIAPTransactionOffer?
}
...
extension AppleIAPTransactionOffer
{
    public static let codecID: UInt32 = 1

    public init<R: IByteReader>(_ r: inout R) throws
    {
        self.id = try r.readRawOptional(String.self)
        self.type = (AppleIAPTransactionOfferType(rawValue: try r.readRaw(Int32.self))!)
        self.payment_mode = try r.readRawOptional(AppleIAPTransactionOfferPaymentMode.self)
    }
    ...
    public func encode<W: IByteWriter>(_ w: inout W) throws
    {
        try w.writeRaw(self.id)
        try w.writeRaw(self.type.rawValue)
        try w.writeRaw(self.payment_mode)
    }
}
...
extension AppleIAPProductsResult
{
    ...
    public init<R: IByteReader>(_ r: inout R) throws
    {
        ...
        self.error = (AppleIAPError(rawValue: try r.readRaw(Int32.self))!)
    ...
    public func encode<W: IByteWriter>(_ w: inout W) throws
    {
        ...
        try w.writeRaw(self.error.rawValue)
...
extension AppleIAPTransaction
{
    ...
    public init<R: IByteReader>(_ r: inout R) throws
    {
        ...
        self.offer = try r.readRawOptional(AppleIAPTransactionOffer.self)
    }
