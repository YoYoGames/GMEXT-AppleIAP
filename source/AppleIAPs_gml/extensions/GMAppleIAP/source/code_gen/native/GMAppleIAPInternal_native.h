...
namespace gm_enums
{
    ...
    enum class AppleIAPError : std::int32_t
    {
        None = 0,
    ...
    enum class AppleIAPTransactionOfferType : std::int32_t
    {
        Introductory = 0,
        Promotional = 1,
        Code = 2,
    ...
    enum class AppleIAPTransactionOfferPaymentMode : std::int32_t
    {
        FreeTrial = 0,
        PayAsYouGo = 1,
        PayUpFront = 2,
...
namespace gm_structs
{
    ...
    struct AppleIAPTransaction
    {
        ...
        std::optional<gm_structs::AppleIAPTransactionOffer> offer;
    };
...
namespace gm::wire::codec
{
    ...
    template<>
    inline void writeValue<gm_structs::AppleIAPTransactionOffer>(gm::byteio::IByteWriter& _buf, const gm_structs::AppleIAPTransactionOffer& obj)
    {
        gm::wire::codec::writeValue(_buf, obj.id);
        gm::wire::codec::writeValue(_buf, obj.type);
        gm::wire::codec::writeValue(_buf, obj.payment_mode);
    }

    template<>
    inline gm_structs::AppleIAPTransactionOffer readValue<gm_structs::AppleIAPTransactionOffer>(gm::byteio::BufferReader& _buf)
    {
        gm_structs::AppleIAPTransactionOffer obj;
    ...
    inline gm_structs::AppleIAPProductsResult readValue<gm_structs::AppleIAPProductsResult>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.error = gm::wire::codec::readValue<gm_enums::AppleIAPError>(_buf);
    ...
    inline void writeValue<gm_structs::AppleIAPTransaction>(gm::byteio::IByteWriter& _buf, const gm_structs::AppleIAPTransaction& obj)
    {
        ...
        gm::wire::codec::writeValue(_buf, obj.offer);
    }
    ...
    inline gm_structs::AppleIAPTransaction readValue<gm_structs::AppleIAPTransaction>(gm::byteio::BufferReader& _buf)
    {
        ...
        obj.offer = gm::wire::codec::readOptional<gm_structs::AppleIAPTransactionOffer>(_buf);
        return obj;
    }
...
namespace gm::wire::details
{
    ...
    template<>
    struct gm_struct_traits<gm_structs::AppleIAPTransactionOffer>
    {
        static constexpr bool is_gm_struct = true;
