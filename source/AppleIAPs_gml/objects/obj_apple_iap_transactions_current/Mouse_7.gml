...
apple_iap_transactions_current_entitlement("yyg_iap_noads", function(result, transaction) {
...
apple_iap_transactions_current_entitlement("yyg_iap_100gems", function(result, transaction) {
